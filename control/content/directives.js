(function (angular) {
    ...
    angular
        .module('geoFencePluginContent')
         .directive('googleLocationSearch', ['ScriptLoaderService', function (ScriptLoaderService) {
          return {
              restrict: 'A',
         ...
         .service('ScriptLoaderService', ['$q', function ($q) {
          this.loadScript = function () {
              ...
              let existingScript = Array.from(document.getElementsByTagName('script')).find(script => script.src === url);
              if (existingScript) {
        ...
        .directive("googleMap", ['$timeout','ScriptLoaderService', function ($timeout,ScriptLoaderService) {
            return {
                template: "<div></div>",
